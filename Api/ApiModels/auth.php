    ...
    class Authentication {
        ...
        public function generate_token() {
            try {
                ...
                $stmt = $this->conn->prepare("SELECT * FROM users WHERE `users`.`username`='$username' ");
